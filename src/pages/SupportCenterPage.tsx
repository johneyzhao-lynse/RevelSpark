        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <div className="bg-white/70 backdrop-blur-md p-6 rounded-2xl shadow-lg border border-white/50 hover:shadow-xl transition-all">
              ...
              <a href="#faq" className="text-blue-600 hover:text-indigo-600 font-medium">查看FAQ →</a>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-md p-6 rounded-2xl shadow-lg border border-white/50 hover:shadow-xl transition-all">
              ...
              <a href="#contact" className="text-blue-600 hover:text-indigo-600 font-medium">联系客服 →</a>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-md p-6 rounded-2xl shadow-lg border border-white/50 hover:shadow-xl transition-all">
              ...
              <a href="#guides" className="text-blue-600 hover:text-indigo-600 font-medium">查看指南 →</a>
            </div>
          </div>
            ...
            <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg border border-white/50 p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="border-b border-gray-200 pb-6">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    AI 闪记卡在连续录音模式下可续航12小时，待机模式下可续航7天。充电时间约1.5小时。
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-600">电话：<a href="tel:+8615618981688" className="text-blue-600 hover:underline">+86 15618981688</a></span>
                    </div>
                    <div className="flex items-center">
                      <svg className="w-5 h-5 text-blue-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <button className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 px-6 rounded-xl font-medium hover:shadow-lg transition-all">
                      在线客服聊天
                    </button>
                    <button className="w-full border-2 border-blue-600 text-blue-600 py-3 px-6 rounded-xl font-medium hover:bg-blue-600 hover:text-white transition-all">
                      提交工单
                    </button>
                  </div>
                </div>
            ...
            <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-lg border border-white/50 p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-white/50 to-blue-50/60 rounded-xl p-6 border border-white/40">
                  ...
                  <p className="text-gray-600 mb-4">5分钟了解如何开始使用AI闪记卡</p>
                  <a href="/support/quick-start" className="text-blue-600 hover:text-indigo-600 font-medium">查看指南 →</a>
                </div>
